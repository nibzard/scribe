...
public:
  ...
  /// @brief Get the underlying ESP-IDF I2C bus handle
  /// @return I2C master bus handle, or nullptr if not initialized
  i2c_master_bus_handle_t handle() const { return bus_handle_; }
