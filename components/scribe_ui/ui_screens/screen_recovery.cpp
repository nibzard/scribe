...
void ScreenRecovery::createWidgets() {
    ...
    lv_label_set_text(title, "Recovered text found");
    ...
    lv_label_set_text(message_label_,
        "We recovered unsaved text from your last session."
    );
    ...
    keep_btn_ = lv_btn_create(screen_);
