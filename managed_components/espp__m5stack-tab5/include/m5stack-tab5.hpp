...
public:
  ...
  /// Access the raw LCD panel IO handle (for esp_lvgl_port integration)
  esp_lcd_panel_io_handle_t lcd_io_handle() const { return lcd_handles_.io; }

  /// Access the raw LCD panel handle (for esp_lvgl_port integration)
